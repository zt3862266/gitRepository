...
<?php global $pings; if ($pings) : ?>
	<h3 id="comments">
	<?php pings_number('No Pings', 'One Ping', '% Pings' );?> to &#8220;<?php the_title(); ?>&#8221;</h3> 
...
<?php if ($comments) : $oddcomment = 'alt';?>
	...
	<?php foreach ($comments as $comment) : ?>
      ...
      <?php if (function_exists('gravatar')): ?>
			<img src="<?php gravatar("R", 60); ?>" class="gravatars" />
      <?php endif; ?>
      
			<?php echo $comment_number; $comment_number += $comment_delta;?>. <cite><?php comment_author_link() ?></cite> Says:
			<?php if ($comment->comment_approved == '0') : ?>
			<em>Your comment is awaiting moderation.</em>
			<?php endif; ?>
			<br />
